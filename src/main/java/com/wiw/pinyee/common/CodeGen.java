...
public class CodeGen {
    public static void main(String[] args) {
        ...
        dataSource.setPassword("yuyuelai");
    ...
    public static GlobalConfig createGlobalConfigUseStyle1() {
        ...
        //设置根包
        globalConfig.setBasePackage("com.wiw");

        //设置表前缀和只生成哪些表
        globalConfig.setTablePrefix("");
        globalConfig.setGenerateTable("table_attr_config", "table_config", "type_config", "type_sel_config");

        //设置生成 entity 并启用 Lombok
        globalConfig.setEntityGenerateEnable(false);
        globalConfig.setEntityWithLombok(true);
        //设置项目的JDK版本，项目的JDK为14及以上时建议设置该项，小于14则可以不设置
        globalConfig.setEntityJdkVersion(22);
